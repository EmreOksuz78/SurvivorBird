package com.emreoksuz.survivorbird;
...
public class SurvivorBird extends ApplicationAdapter {
    ...
    @Override
    public void create() {
        //Oyun açıldığında olucak şeyler
    ...
    public void render() {
        ...
        batch.begin();
        //Yükseklik ve Uzunluğu bul diyoruz
        batch.draw(background, 0, 0, Gdx.graphics.getWidth(), Gdx.graphics.getHeight());

        //Oyun açıldığında olucak şeyler sürekli olucak şeyler buraya yazılır

		/*//Ekrana dokunulduğunda ne olacağını buraya yazıyoruz.
        ...
        birdCircle.set(birdX+Gdx.graphics.getWidth()/60,birdY+Gdx.graphics.getHeight() / 40,Gdx.graphics.getWidth()/60);
